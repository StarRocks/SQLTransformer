...
public class ReferredPartitionsDetector extends AstVisitor {
    ...
    private boolean isNeedPartitionDetection = true;
    ...
    public ReferredPartitionsDetector(String todayDate, String targetIp, MetadataService metadataService, boolean isNeedPartitionDetection) {
        this.todayDate = todayDate;
        this.targetIp = targetIp;
        this.metadataService = metadataService;
        this.isNeedPartitionDetection = isNeedPartitionDetection;
    }
